...
included_cam_launch = IncludeLaunchDescription(
    ...
    remappings=[
        ('/image_raw', '/jetson_1/image_raw'),
        ('/camera_info', '/jetson_1/camera_info')
    ]
)
    ...
    ping1d_node = Node(
        ...
        output="screen",
        remappings=[
        ('/bar30/depth', '/jetson_1/bar30/depth'),
        ('/bar30/pressure', '/jetson_1/bar30/pressure'),
        ('/bar30/temperature', '/jetson_1/bar30/temperature')
    ]
    )
    ...
    included_imu_launch = IncludeLaunchDescription(
      PythonLaunchDescriptionSource(_MICROSTRAIN_LAUNCH_FILE),
         remappings=[
        ('/imu/data', '/jetson_1/imu/data'),
        ('/ekf/status', '/jetson_1/ekf/status')
    ]
    )
